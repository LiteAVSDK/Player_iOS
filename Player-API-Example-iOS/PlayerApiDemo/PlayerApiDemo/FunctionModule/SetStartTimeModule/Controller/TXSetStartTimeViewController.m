//
//  TXSetStartTimeViewController.m
//  PlayerApiDemo
//
//  Copyright (c) 2022 Tencent. All rights reserved.
//  本模块主要介绍如何使用腾讯云点播播放器设置视频启播时间

#import "TXSetStartTimeViewController.h"
#import "TXSetStartTimeLocalized.h"
#import "TXSetStartTimeLayout.h"
#import "TXSetStartTimeResource.h"
#import "TXSetStartTimeColor.h"
#import <TXLiteAVSDK_Player/TXVodPlayer.h>
#import <Masonry/Masonry.h>

@interface TXSetStartTimeViewController ()
...
@implementation TXSetStartTimeViewController
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    // 设置导航栏标题
    self.title = SetStartTimeLocalize(@"PLAYER-API-Example.Function.SetStartTime.title");
...
- (void)setStartTime {
    // 设置视频启播时间
    [self.vodPlayer setStartTime:START_TIME];
}
