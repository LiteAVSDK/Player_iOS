...
+ (instancetype)boxWithTitle:(NSString *)title{
    ...
    box.ctrlStatusImgView.image = [UIImage imageNamed:@"btn_unselected"];
...
- (void)clickAction{
    ...
    if (self.selected) {
        self.ctrlStatusImgView.image = [UIImage imageNamed:@"btn_selected"];
    } else {
        self.ctrlStatusImgView.image = [UIImage imageNamed:@"btn_unselected"];
    }
