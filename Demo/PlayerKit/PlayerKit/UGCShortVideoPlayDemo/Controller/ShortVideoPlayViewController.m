...
- (void)viewDidLoad {
    ...
    ///隐藏左滑list self.childVCs = @[self.mainVC, self.videoListVC];
    self.childVCs = @[self.mainVC];
...
- (UIScrollView *)mainScrollView {
    if (!_mainScrollView) {
        ...
        //隐藏左滑list _mainScrollView.contentSize = CGSizeMake(SCREEN_WIDTH * 2, SCREEN_HEIGHT);
