...
@interface VideoCacheListView()<UITableViewDelegate, UITableViewDataSource, TPScanQRDelegate>
...
@property (nonatomic, strong) TPScanQRController *scanVC;
...
- (UIButton *)backBtn {
    if (!_backBtn) {
        ...
        UIImage *backImage = [UIImage imagewithName:@"back_full" bundleName:@"PlayerKitBundle"];
...
- (UIButton *)helpBtn {
    if (!_helpBtn) {
        ...
        [_helpBtn setBackgroundImage:[UIImage imagewithName:@"help_small" bundleName:@"PlayerKitBundle"] forState:UIControlStateNormal];
...
- (UIButton *)scanBtn {
    if (!_scanBtn) {
        ...
        [_scanBtn setBackgroundImage:[UIImage imagewithName:@"扫码" bundleName:@"PlayerKitBundle"] forState:UIControlStateNormal];
...
- (void)clickScan {
    self.scanVC = [[TPScanQRController alloc] init];
