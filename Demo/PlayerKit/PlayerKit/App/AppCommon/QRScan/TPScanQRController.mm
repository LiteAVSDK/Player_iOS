...
static const char *kTPScanQRCodeQueueName = "TPScanQRCodeQueue";


@interface TPScanQRController ()<AVCaptureMetadataOutputObjectsDelegate>
{
...
@implementation TPScanQRController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)startScan
{
    ...
    dispatchQueue = dispatch_queue_create(kTPScanQRCodeQueueName, NULL);
