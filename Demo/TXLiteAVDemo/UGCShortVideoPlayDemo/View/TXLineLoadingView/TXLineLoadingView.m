...
@implementation TXLineLoadingView
...
+ (void)showLoadingInView:(UIView *)view withLineHeight:(CGFloat)lineHeight {
    TXLineLoadingView *loadingView = [[TXLineLoadingView alloc] initWithFrame:view.frame lineHeight:lineHeight];
...
+ (void)hideLoadingInView:(UIView *)view {
    ...
    for (UIView *subView in subviewsEnum) {
        if ([subView isKindOfClass:[TXLineLoadingView class]]) {
            TXLineLoadingView *loadingView = (TXLineLoadingView *)subView;
