...
- (void)initSubtitlesSettingView {
    ...
    NSInteger isInit = [dic[@"isInit"] integerValue];
    if (isInit == 0){
...
- (void)setDefaultBtnStatus {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(onSettingViewDoneClickWithDic:)]) {
        ...
        mDic[@"fontColor"] = @([self getFontColor:self.fontColorType]);
        mDic[@"bondFont"] = @([self getBondFont:self.bondFontType]);
        mDic[@"outlineWidth"] = @([self getOutlineWidth:self.outlineWidthType]);
        mDic[@"outlineColor"] = @([self getOutlineColor:self.outlineColorType]);
...
- (void)defaultPlayerConfig {
    ...
    [mDic setObject:@(1) forKey:@"isInit"];
...
- (NSDictionary *)subtitlesConfig {
    NSDictionary *dic = [[NSUserDefaults standardUserDefaults] objectForKey:@"subtitlesConfig"];
    NSInteger fontColorType = [[dic objectForKey:@"fontColor"] integerValue];
    NSInteger bondFontType = [[dic objectForKey:@"bondFont"] integerValue];
    NSInteger outlineWidthType = [[dic objectForKey:@"outlineWidth"] integerValue];
    NSInteger outlineColorType = [[dic objectForKey:@"outlineColor"] integerValue];
    
    NSMutableDictionary *mDic = [NSMutableDictionary dictionary];
    mDic[@"fontColor"] = @([self getFontColor:fontColorType]);
    mDic[@"bondFont"] = @([self getBondFont:bondFontType]);
    mDic[@"outlineWidth"] = @([self getOutlineWidth:outlineWidthType]);
    mDic[@"outlineColor"] = @([self getOutlineColor:outlineColorType]);
